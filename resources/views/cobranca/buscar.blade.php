    ...
    <div class="container-fluid text-black">
        <div class="row align-items-start justify-content-center mx-auto">
            <div class="text-center col-12 p-1 mt-5">
                <h1 class="display-3">° Busca Cobranças °</h1>
            </div>
            <form action="{{route('cobranca.menu')}}" method="get">
            @csrf
                <div class="form-group text-center col-12">
                    <div class="form-group col-12 col-md-6 my-1 d-block mx-auto m-1">
                        <h5><label for="meseano" class="link-dark link-underline-opacity-0">Mês e Ano</label></h5>
                        <input type="month" class="h6 rounded p-1 border-light-subtle" name="meseano" id="meseano" placeholder="">
                    </div>
                    <div class="form-group col-12 col-md-6 my-1 d-block mx-auto m-1">
                        <h5><label for="dia" class="link-dark link-underline-opacity-0">Dia</label></h5>
                        <input type="text" class="h6 col-12 col-md-6 rounded p-1 border-light-subtle   " name="dia" id="dia" placeholder="Digite o dia da cobrança">
                    </div>
                    <div class="form-group col-12 col-md-6 my-1 d-block mx-auto m-1">
                        <h5><label for="nomedocliente" class="link-dark link-underline-opacity-0">Nome do Cliente</label></h5>
                        <input type="text" class="h6 col-12 col-md-6 rounded p-1 border-light-subtle" name="nomedocliente" id="nomedocliente" placeholder="Digite o nome do cliente">
                    </div>
                    <div class="col-12 col-md-6 my-1 d-block mx-auto m-1">
                        <h5><label for="cpf" class="link-dark link-underline-opacity-0">CPF do Cliente</label></h5>
                        <input type="number" class="h6 col-12 col-md-6 rounded p-1 border-light-subtle" name="cpf" id="cpf" placeholder="Digite o cpf do cliente">
                    </div>
                    <input type="submit" value="Buscar Cobrança(s)" class="h6 ps-1 pe-1 mt-2 pt-0 pb-0 ms-2 btn btn-primary">
                </div>
            </form>
            <div class="mt-4">
            </div>
