...
<div class="mb-4">
        ...
        <div class="row align-items-start justify-content-center mx-auto">
            <div class="text-center col-12 p-1 mt-5">
                <h1 class="display-3">° Atrasos Totais °</h1>
            </div>
            <form action="{{route('cobranca.atrasados')}}" method="get">
                @csrf
                    <div class="form-group text-center col-12">
                        <div class="form-group col-12 col-md-6 my-1 d-block mx-auto m-1">
                            <h5><label for="data" class="link-dark link-underline-opacity-0">Mês da Cobrança</label></h5>
                            <input type="month" class="h6 rounded p-1 border-light-subtle" name="meseano" id="meseano">
                        ...
                        <div class="mt-3 row align-items-start justify-content-center mx-auto text-center col-12 col-md-6">
                            <table class="table border-black">
                                <tr>
                                    <td class="bg-dark-subtle"><b>Valor em atrasado</b></td>
                                    <td class="bg-dark-subtle"><b>270,00</b></td>
                                  </tr>
                              <tr>
                                <tr>
                                    <td class="bg-dark-subtle"><b>Clientes em atraso</b></td>
                            ...
                            <table class="table table-striped">
                                <thead class="thead-dark">
                                  <tr>
                                    <th scope="col" class="bg-danger-subtle">Nome <i class="bi bi-arrow-down-up"></i></th>
                                    <th scope="col" class="bg-danger-subtle">R$ <i class="bi bi-arrow-down-up"></i></th>
                                    <th scope="col" class="bg-danger-subtle"><i class="bi bi-calendar2"></i></th>
                                    </tr>
                                </thead>
                                <tbody>
                                  ...
                                  <tr>
                                    ...
                                    <td>90,00</td>
                                    <td><a href="{{route('cobranca.recebimento')}}   "><i class="bi bi-cash-coin h3 text-danger"></i></a></td>
                                  </tr>
                                  <tr>
