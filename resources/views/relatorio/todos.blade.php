    ...
    <div class="mb-4">
        ...
        <div class="row align-items-start justify-content-center mx-auto">
            <div class="text-center col-12 p-1 mt-5">
                <h1 class="display-3">° Todos os Relatórios °</h1>
            </div>
            <form action="{{route('relatorio.todos')}}" method="get">
                @csrf
                        ...
                        <div class="mt-1 row align-items-start justify-content-center mx-auto text-center col-12 col-md-6">
                            <table class="table table-striped">
                                <thead class="table align-center text-center border-black">
                                    <tr>
                                        <th class="bg-dark-subtle" scope="col">COBRANÇAS</th>
                                        <th class="bg-dark-subtle" scope="col">Valores</th>
                                        <th class="bg-dark-subtle" scope="col">%</th>
                                    </tr>
                                    <tr>
                                        <th class="bg-dark-subtle">Parcelas do Mês</th>
                                        <th class="bg-dark-subtle">10.000,00    </th>
                                        <th class="bg-dark-subtle">100%</th>
                                    </tr>
                                </thead>
                                <tbody>
                                  <tr>
                                    <th scope="row">Total Recebido</th>
                                    <th class="bg-success-subtle font-weight-bold text-dark">R$4.000,00</th>
                                    <th>40%</th>
                                  </tr>
                                  <tr>
                                    <th scope="row">Total a Receber</th>
                                    <th class="bg-primary-subtle font-weight-bold text-dark">R$4.500,00</th>
                                    <th>45%</th>
                                  </tr>
                                  <tr>
                                    <th scope="row">Atrasados do mês</th>
                                    <th class="bg-warning-subtle font-weight-bold text-dark">R$1.000,00</th>
                                    <th>10%</th>
                                  </tr>
                                  <tr>
                                    <th scope="row">Total de Prejuízo</th>
                                    <th class="bg-danger-subtle font-weight-bold text-dark">R$500,00</th>
                                    <th>5%</th>
                                  </tr>
                                </tbody>
                              </table>
                              <table class="table table-striped">
                                <thead class="table align-center text-center border-black">
                                  <tr>
                                    <th class="bg-dark-subtle" scope="col">VENDAS</th>
                                    <th class="bg-dark-subtle" scope="col">Valores</th>
                                    </tr>
                                </thead>
                                <tbody>
                                  <tr>
                                    <th scope="row">Valor Total Vendido</th>
                                    <th class="font-weight-bold text-dark">R$10.000,00</th>
                                  </tr>
                                  <tr>
                                    <th scope="row">Nº de Vendas</th>
                                    <th class="font-weight-bold text-dark">4</th>
                                  </tr>
                                  <tr>
                                    <th scope="row">Valor Médio por Venda<br>(Ticket Médio)</th>
                                    <th class="font-weight-bold text-dark">R$2.500,00</th>
                                  </tr>
                                  <tr>
                                    <th scope="row">Valor da Maior Venda</th>
                                    <th class="font-weight-bold text-dark">R$4.000.00</th>
                                  </tr>
                                  <tr>
                                    <th scope="row">Valor da Menor Venda</th>
                                    <th class="font-weight-bold text-dark">R$1.000,00</th>
                                  </tr>
                                  <tr>
                                    <th scope="row">Nº de Produtos Vendidos</th>
                                    <th class="font-weight-bold text-dark">10</th>
                                  </tr>
                                  <tr>
                                    <th scope="row">Valor Médio por Produto</th>
                                    <th class="font-weight-bold text-dark">R$1.000,00</th>
                                  </tr>
                                  <tr>
                                    <th scope="row">Produto Mais Vendido</th>
                                    <th class="font-weight-bold text-dark">Cadeira de fio</th>
                                  </tr>
                                  <tr>
                                    <th scope="row">Nº de Clientes Ativos</th>
                                    <th class="font-weight-bold text-dark">3</th>
                                  </tr>
                                </tbody>
                              </table>
                              <table class="table table-striped">
                                <thead class="table align-center text-center border-black">
                                  <tr>
                                    <th class="bg-dark-subtle" scope="col">LUCRO E CUSTO</th>
                                    <th class="bg-dark-subtle" scope="col">Valores</th>
                                    </tr>
                                </thead>
                                <tbody>
                              ...
                              <table class="table table-striped">
                                <thead class="table align-center text-center border-black">
                                  <tr>
                                    <th class="bg-dark-subtle" scope="col">INADIMPLÊNCIA</th>
                                    <th class="bg-dark-subtle" scope="col">Valores</th>
                                    </tr>
                                </thead>
                                <tbody>
                                  <tr>
                                    <th scope="row">Inadimplência Total</th>
                                    <th class="bg-danger-subtle font-weight-bold text-dark">R$2.000,00</th>
                                  </tr>
                                  <tr>
                                    <th scope="row">Aumento/Redução Mensal</th>
                                    <th class="bg-success-subtle font-weight-bold text-dark">-7,5%</th>
                                  </tr>
                                  <tr>
                                    <th scope="row">Nº de Clientes Inadimplentes</th>
                                    <th class="font-weight-bold text-dark">4</th>
                                  </tr>
                                  <tr>
                                    <th scope="row">Perdas do Mês</th>
                                    <th class="font-weight-bold text-dark">R$0,00</th>
                                  </tr>
                                </tbody>
                              </table>
                            </div>
